...
func (t Training) distance() float64 {
	...
	var ls float64 = LenStep
	result := (float64(t.Action) * ls) / MInKm
	return result
}
...
func (t Training) meanSpeed() float64 {
	// вставьте ваш код ниже
	var dist float64 = t.distance()
	result := dist / float64(t.Duration.Hours())
	return result
}
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	var cmsm float64 = CaloriesMeanSpeedMultiplier
	var cmss float64 = CaloriesMeanSpeedShift
	//var ms float64 = r.meanSpeed()
	result := ((cmsm*r.meanSpeed() + cmss) * r.Weight / MInKm * r.Duration.Hours() * MinInHours)
	return result
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	var kminsec float64 = KmHInMsec
	var wms float64 = w.meanSpeed()
	result := ((CaloriesWeightMultiplier*w.Weight + (((math.Pow(wms*kminsec, 2))/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight)*float64(w.Duration.Hours())) * MinInHours)
	return result
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	var minkm float64 = MInKm
	result := float64(s.LengthPool) * float64(s.CountPool) / (minkm) / s.Duration.Hours()
	return result
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	result := (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * float64(s.Duration.Hours())
	return result
}
